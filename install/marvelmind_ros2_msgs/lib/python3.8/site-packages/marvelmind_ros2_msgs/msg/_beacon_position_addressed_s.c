...
bool marvelmind_ros2_msgs__msg__beacon_position_addressed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marvelmind_ros2_msgs.msg._beacon_position_addressed.BeaconPositionAddressed", full_classname_dest, 75) == 0);
  }
  marvelmind_ros2_msgs__msg__BeaconPositionAddressed * ros_message = _ros_message;
  {  // address
...
{
  /* NOTE(esteve): Call constructor of BeaconPositionAddressed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marvelmind_ros2_msgs.msg._beacon_position_addressed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BeaconPositionAddressed");
