...
bool marvelmind_ros2_msgs__msg__hedge_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marvelmind_ros2_msgs.msg._hedge_position.HedgePosition", full_classname_dest, 54) == 0);
  }
  marvelmind_ros2_msgs__msg__HedgePosition * ros_message = _ros_message;
  {  // timestamp_ms
...
{
  /* NOTE(esteve): Call constructor of HedgePosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marvelmind_ros2_msgs.msg._hedge_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HedgePosition");
