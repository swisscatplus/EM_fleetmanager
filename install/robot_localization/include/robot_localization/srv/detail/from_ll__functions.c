...
{
  robot_localization__srv__FromLL_Request * msg = (robot_localization__srv__FromLL_Request *)malloc(sizeof(robot_localization__srv__FromLL_Request));
  if (!msg) {
    return NULL;
  }
...
robot_localization__srv__FromLL_Request__Sequence__init(robot_localization__srv__FromLL_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (robot_localization__srv__FromLL_Request *)calloc(size, sizeof(robot_localization__srv__FromLL_Request));
    if (!data) {
      return false;
    }
...
{
  robot_localization__srv__FromLL_Request__Sequence * array = (robot_localization__srv__FromLL_Request__Sequence *)malloc(sizeof(robot_localization__srv__FromLL_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  robot_localization__srv__FromLL_Response * msg = (robot_localization__srv__FromLL_Response *)malloc(sizeof(robot_localization__srv__FromLL_Response));
  if (!msg) {
    return NULL;
  }
...
robot_localization__srv__FromLL_Response__Sequence__init(robot_localization__srv__FromLL_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (robot_localization__srv__FromLL_Response *)calloc(size, sizeof(robot_localization__srv__FromLL_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  robot_localization__srv__FromLL_Response__Sequence * array = (robot_localization__srv__FromLL_Response__Sequence *)malloc(sizeof(robot_localization__srv__FromLL_Response__Sequence));
  if (!array) {
    return NULL;
  }
