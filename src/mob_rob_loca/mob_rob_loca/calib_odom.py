...
def main():
    ...
    station_OTL = Station(posX = 0.0, posY = 2.633, orientationZ = 0.7071068, orientationW = 0.7071068)
    station_OTR = Station(posX = 0.80, posY = 2.633, orientationZ = 0.0, orientationW = 1.0)
    station_OBR = Station(posX = 0.80, posY = 0.0, orientationZ = 0.7071068, orientationW = -0.7071068)
