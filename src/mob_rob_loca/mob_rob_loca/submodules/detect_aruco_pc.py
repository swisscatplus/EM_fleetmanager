...
class CameraVisionStation:
    ...
    def __init__(self, cam_params=None, aruco_params=None, cam_frame=(447, 569)):
        ...
        self.logger.info(f"aruco_square_size: {self.aruco_square_size}")
        self.logger.info(f"dist_cam_robot_center: {self.dist_cam_robot_center}")
        self.logger.info(f"Aruco parameters: {self.aruco_params}")
