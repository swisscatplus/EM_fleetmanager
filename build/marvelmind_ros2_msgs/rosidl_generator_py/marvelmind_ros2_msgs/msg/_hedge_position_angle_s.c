...
bool marvelmind_ros2_msgs__msg__hedge_position_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marvelmind_ros2_msgs.msg._hedge_position_angle.HedgePositionAngle", full_classname_dest, 65) == 0);
  }
  marvelmind_ros2_msgs__msg__HedgePositionAngle * ros_message = _ros_message;
  {  // address
...
{
  /* NOTE(esteve): Call constructor of HedgePositionAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marvelmind_ros2_msgs.msg._hedge_position_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HedgePositionAngle");
