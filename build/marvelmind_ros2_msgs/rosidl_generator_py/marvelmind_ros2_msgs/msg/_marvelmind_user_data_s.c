...
bool marvelmind_ros2_msgs__msg__marvelmind_user_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marvelmind_ros2_msgs.msg._marvelmind_user_data.MarvelmindUserData", full_classname_dest, 65) == 0);
  }
  marvelmind_ros2_msgs__msg__MarvelmindUserData * ros_message = _ros_message;
  {  // timestamp_ms
...
{
  /* NOTE(esteve): Call constructor of MarvelmindUserData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marvelmind_ros2_msgs.msg._marvelmind_user_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MarvelmindUserData");
