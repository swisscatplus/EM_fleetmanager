...
#include "marvelmind_ros2_msgs/msg/detail/hedge_position_angle__rosidl_typesupport_microxrcedds_c.h"
...
typedef marvelmind_ros2_msgs__msg__HedgePositionAngle _HedgePositionAngle__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _HedgePositionAngle__ros_msg_type * ros_message = (_HedgePositionAngle__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: angle
  rv = ucdr_serialize_double(cdr, ros_message->angle);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: angle
  rv = ucdr_deserialize_double(cdr, &ros_message->angle);
  return rv;
}
  ...
  size_t current_alignment)
{
  ...
  const _HedgePositionAngle__ros_msg_type * ros_message = (const _HedgePositionAngle__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: angle
  {
    const size_t item_size = sizeof(ros_message->angle);
    current_alignment += ucdr_alignment(current_alignment, item_size) + item_size;
  }
...
static size_t _HedgePositionAngle__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_marvelmind_ros2_msgs__msg__HedgePositionAngle(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, marvelmind_ros2_msgs, msg, HedgePositionAngle)() {
