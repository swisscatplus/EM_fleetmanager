...
static const _GetCriticScore_Request_type_support_symbol_names_t _GetCriticScore_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GetCriticScore_Request)),
  }
};
...
static const _GetCriticScore_Response_type_support_symbol_names_t _GetCriticScore_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GetCriticScore_Response)),
  }
};
...
static const _GetCriticScore_type_support_symbol_names_t _GetCriticScore_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GetCriticScore)),
  }
};
