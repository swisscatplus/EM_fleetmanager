...
static const _GenerateTrajectory_Request_type_support_symbol_names_t _GenerateTrajectory_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTrajectory_Request)),
  }
};
...
static const _GenerateTrajectory_Response_type_support_symbol_names_t _GenerateTrajectory_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTrajectory_Response)),
  }
};
...
static const _GenerateTrajectory_type_support_symbol_names_t _GenerateTrajectory_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTrajectory)),
  }
};
