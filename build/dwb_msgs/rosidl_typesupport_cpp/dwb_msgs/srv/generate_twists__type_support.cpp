...
static const _GenerateTwists_Request_type_support_symbol_names_t _GenerateTwists_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTwists_Request)),
  }
};
...
static const _GenerateTwists_Response_type_support_symbol_names_t _GenerateTwists_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTwists_Response)),
  }
};
...
static const _GenerateTwists_type_support_symbol_names_t _GenerateTwists_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, GenerateTwists)),
  }
};
