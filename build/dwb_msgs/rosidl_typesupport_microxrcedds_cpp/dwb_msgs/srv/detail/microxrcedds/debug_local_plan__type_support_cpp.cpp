...
#include "dwb_msgs/srv/detail/debug_local_plan__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _DebugLocalPlan_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _DebugLocalPlan_Request__callbacks = {
  ...
  _DebugLocalPlan_Request__get_serialized_size_with_initial_alignment,
...
{
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, DebugLocalPlan_Request)() {
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: results
  current_alignment += dwb_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_LocalPlanEvaluation(
    full_bounded,
    current_alignment);
...
static size_t _DebugLocalPlan_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const dwb_msgs::srv::DebugLocalPlan_Response *>(
...
static message_type_support_callbacks_t _DebugLocalPlan_Response__callbacks = {
  ...
  _DebugLocalPlan_Response__get_serialized_size_with_initial_alignment,
...
{
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, DebugLocalPlan_Response)() {
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan_Response__handle;
}
...
{
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, dwb_msgs, srv, DebugLocalPlan)() {
  return &dwb_msgs::srv::typesupport_microxrcedds_cpp::_DebugLocalPlan__handle;
}
