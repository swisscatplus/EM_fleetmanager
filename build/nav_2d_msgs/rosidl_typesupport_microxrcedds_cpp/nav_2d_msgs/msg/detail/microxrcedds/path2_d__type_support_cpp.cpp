...
#include "nav_2d_msgs/msg/detail/path2_d__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Path2D__get_serialized_size_with_initial_alignment(
...
static size_t _Path2D__max_serialized_size()
{
  bool full_bounded;
...
static message_type_support_callbacks_t _Path2D__callbacks = {
  ...
  _Path2D__get_serialized_size_with_initial_alignment,
...
{
  return &nav_2d_msgs::msg::typesupport_microxrcedds_cpp::_Path2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav_2d_msgs, msg, Path2D)() {
  return &nav_2d_msgs::msg::typesupport_microxrcedds_cpp::_Path2D__handle;
}
