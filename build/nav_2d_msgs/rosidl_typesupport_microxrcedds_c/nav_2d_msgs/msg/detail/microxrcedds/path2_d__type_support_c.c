...
#include "nav_2d_msgs/msg/detail/path2_d__rosidl_typesupport_microxrcedds_c.h"
...
typedef nav_2d_msgs__msg__Path2D _Path2D__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Path2D__ros_msg_type * ros_message = (_Path2D__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Path2D__ros_msg_type * ros_message = (const _Path2D__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_nav_2d_msgs__msg__Path2D(&full_bounded, 0);
}
