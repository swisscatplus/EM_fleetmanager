...
#include "robot_localization/srv/detail/set_datum__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: geo_pose
  current_alignment += geographic_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_GeoPose(
    full_bounded,
    current_alignment);
...
static size_t _SetDatum_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _SetDatum_Request__callbacks = {
  ...
  _SetDatum_Request__get_serialized_size_with_initial_alignment,
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum_Request)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum_Request__handle;
}
...
static size_t _SetDatum_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const robot_localization::srv::SetDatum_Response *>(
...
static message_type_support_callbacks_t _SetDatum_Response__callbacks = {
  ...
  _SetDatum_Response__get_serialized_size_with_initial_alignment,
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum_Response)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum_Response__handle;
}
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_SetDatum__handle;
}
