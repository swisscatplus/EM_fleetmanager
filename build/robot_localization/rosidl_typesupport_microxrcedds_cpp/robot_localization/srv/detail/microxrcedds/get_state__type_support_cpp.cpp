...
#include "robot_localization/srv/detail/get_state__rosidl_typesupport_microxrcedds_cpp.hpp"
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, GetState_Request)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState_Request__handle;
}
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: state
  {
    ...
    rv = ucdr_serialize_array_double(cdr, ros_message.state.data(), size);
  }
  // Member: covariance
  {
  ...
  robot_localization::srv::GetState_Response & ros_message)
{
  ...
  // Member: state
  {
    ...
    rv = ucdr_deserialize_array_double(cdr, ros_message.state.data(), size);
  }
  // Member: covariance
  {
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, GetState_Response)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState_Response__handle;
}
...
{
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, GetState)() {
  return &robot_localization::srv::typesupport_microxrcedds_cpp::_GetState__handle;
}
