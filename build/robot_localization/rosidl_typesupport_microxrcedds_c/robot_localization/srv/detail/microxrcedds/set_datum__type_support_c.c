...
#include "robot_localization/srv/detail/set_datum__rosidl_typesupport_microxrcedds_c.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geographic_msgs, msg, GeoPose)();


typedef robot_localization__srv__SetDatum_Request _SetDatum_Request__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetDatum_Request__ros_msg_type * ros_message = (_SetDatum_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;

  // Member: geo_pose
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geographic_msgs, msg, GeoPose
      )()->data))->cdr_serialize(&ros_message->geo_pose, cdr);
  ...
  void * untyped_ros_message)
{
  ...
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geographic_msgs, msg, GeoPose
      )()->data))->cdr_deserialize(cdr, &ros_message->geo_pose);
  return rv;
}
  ...
  size_t current_alignment)
{
  ...
  const _SetDatum_Request__ros_msg_type * ros_message = (const _SetDatum_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: geo_pose
  current_alignment +=
    get_serialized_size_geographic_msgs__msg__GeoPose(&ros_message->geo_pose, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: geo_pose
  current_alignment +=
    max_serialized_size_geographic_msgs__msg__GeoPose(full_bounded, current_alignment);

  return current_alignment - initial_alignment;
}

static size_t _SetDatum_Request__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_robot_localization__srv__SetDatum_Request(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, robot_localization, srv, SetDatum_Request)() {
...
typedef robot_localization__srv__SetDatum_Response _SetDatum_Response__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetDatum_Response__ros_msg_type * ros_message = (_SetDatum_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _SetDatum_Response__ros_msg_type * ros_message = (const _SetDatum_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _SetDatum_Response__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_robot_localization__srv__SetDatum_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, robot_localization, srv, SetDatum_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, robot_localization, srv, SetDatum)() {
