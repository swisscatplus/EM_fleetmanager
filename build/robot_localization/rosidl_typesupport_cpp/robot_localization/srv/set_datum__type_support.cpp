...
static const _SetDatum_Request_type_support_symbol_names_t _SetDatum_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum_Request)),
  }
};
...
static const _SetDatum_Response_type_support_symbol_names_t _SetDatum_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum_Response)),
  }
};
...
static const _SetDatum_type_support_symbol_names_t _SetDatum_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, robot_localization, srv, SetDatum)),
  }
};
