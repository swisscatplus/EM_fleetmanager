...
#include "nav2_msgs/msg/detail/costmap__rosidl_typesupport_microxrcedds_c.h"
...
typedef nav2_msgs__msg__Costmap _Costmap__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Costmap__ros_msg_type * ros_message = (_Costmap__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, msg, CostmapMetaData
      )()->data))->cdr_serialize(&ros_message->metadata, cdr);
  // Member: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, msg, CostmapMetaData
      )()->data))->cdr_deserialize(cdr, &ros_message->metadata);
  // Field name: data
  {
    uint32_t size;
  ...
  size_t current_alignment)
{
  ...
  const _Costmap__ros_msg_type * ros_message = (const _Costmap__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: metadata
  current_alignment +=
    get_serialized_size_nav2_msgs__msg__CostmapMetaData(&ros_message->metadata, current_alignment);
  // Member: data
  {
...
{
  bool full_bounded;
  return max_serialized_size_nav2_msgs__msg__Costmap(&full_bounded, 0);
}
