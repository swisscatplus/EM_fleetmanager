...
#include "nav2_msgs/srv/detail/load_map__rosidl_typesupport_microxrcedds_c.h"
...
typedef nav2_msgs__srv__LoadMap_Request _LoadMap_Request__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_nav2_msgs__srv__LoadMap_Request(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, LoadMap_Request)() {
...
typedef nav2_msgs__srv__LoadMap_Response _LoadMap_Response__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_nav2_msgs__srv__LoadMap_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, LoadMap_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, LoadMap)() {
