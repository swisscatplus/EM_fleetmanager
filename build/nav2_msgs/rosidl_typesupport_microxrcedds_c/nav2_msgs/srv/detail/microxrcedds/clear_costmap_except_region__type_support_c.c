...
#include "nav2_msgs/srv/detail/clear_costmap_except_region__rosidl_typesupport_microxrcedds_c.h"
...
typedef nav2_msgs__srv__ClearCostmapExceptRegion_Request _ClearCostmapExceptRegion_Request__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _ClearCostmapExceptRegion_Request__ros_msg_type * ros_message = (_ClearCostmapExceptRegion_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _ClearCostmapExceptRegion_Request__ros_msg_type * ros_message = (const _ClearCostmapExceptRegion_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _ClearCostmapExceptRegion_Request__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_nav2_msgs__srv__ClearCostmapExceptRegion_Request(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, ClearCostmapExceptRegion_Request)() {
...
typedef nav2_msgs__srv__ClearCostmapExceptRegion_Response _ClearCostmapExceptRegion_Response__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _ClearCostmapExceptRegion_Response__ros_msg_type * ros_message = (_ClearCostmapExceptRegion_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _ClearCostmapExceptRegion_Response__ros_msg_type * ros_message = (const _ClearCostmapExceptRegion_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _ClearCostmapExceptRegion_Response__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_nav2_msgs__srv__ClearCostmapExceptRegion_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, ClearCostmapExceptRegion_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav2_msgs, srv, ClearCostmapExceptRegion)() {
