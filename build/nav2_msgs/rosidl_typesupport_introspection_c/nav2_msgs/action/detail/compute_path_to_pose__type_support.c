...
static rosidl_typesupport_introspection_c__MessageMember ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[4] = {
  {
    "goal",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, ComputePathToPose_Goal)() {
  ...
  ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PoseStamped)();
