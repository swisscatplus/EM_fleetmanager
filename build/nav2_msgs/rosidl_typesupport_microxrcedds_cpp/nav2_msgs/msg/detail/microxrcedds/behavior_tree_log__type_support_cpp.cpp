...
#include "nav2_msgs/msg/detail/behavior_tree_log__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _BehaviorTreeLog__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _BehaviorTreeLog__callbacks = {
  ...
  _BehaviorTreeLog__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_BehaviorTreeLog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, msg, BehaviorTreeLog)() {
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_BehaviorTreeLog__handle;
}
