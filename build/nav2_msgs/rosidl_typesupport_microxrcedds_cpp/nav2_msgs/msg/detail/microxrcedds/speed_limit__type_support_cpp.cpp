...
#include "nav2_msgs/msg/detail/speed_limit__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  rv = std_msgs::msg::typesupport_microxrcedds_cpp::cdr_serialize(
    ...
    cdr);
  // Member: percentage
  rv = ucdr_serialize_bool(cdr, ros_message.percentage);
  // Member: speed_limit
...
static size_t _SpeedLimit__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _SpeedLimit__callbacks = {
  ...
  _SpeedLimit__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_SpeedLimit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, msg, SpeedLimit)() {
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_SpeedLimit__handle;
}
