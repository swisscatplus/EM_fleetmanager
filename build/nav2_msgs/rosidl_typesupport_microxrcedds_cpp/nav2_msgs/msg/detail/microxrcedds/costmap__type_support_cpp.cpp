...
#include "nav2_msgs/msg/detail/costmap__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Costmap__get_serialized_size_with_initial_alignment(
...
static size_t _Costmap__max_serialized_size()
{
  bool full_bounded;
...
static message_type_support_callbacks_t _Costmap__callbacks = {
  ...
  _Costmap__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_Costmap__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, msg, Costmap)() {
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_Costmap__handle;
}
