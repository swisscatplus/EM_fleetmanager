...
#include "nav2_msgs/msg/detail/costmap_meta_data__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  rv = builtin_interfaces::msg::typesupport_microxrcedds_cpp::cdr_serialize(
    ...
    cdr);
  // Member: layer
  rv = ucdr_serialize_string(cdr, ros_message.layer.c_str());
  // Member: resolution
  ...
  nav2_msgs::msg::CostmapMetaData & ros_message)
{
  ...
  rv = builtin_interfaces::msg::typesupport_microxrcedds_cpp::cdr_deserialize(
    ...
    ros_message.update_time);
  // Member: layer
  ros_message.layer.resize(ros_message.layer.capacity());
  rv = ucdr_deserialize_string(cdr, &ros_message.layer[0], ros_message.layer.capacity());
  if (rv) {
    ros_message.layer.resize(std::strlen(&ros_message.layer[0]));
  }
  // Member: resolution
...
static size_t _CostmapMetaData__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _CostmapMetaData__callbacks = {
  ...
  _CostmapMetaData__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_CostmapMetaData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, msg, CostmapMetaData)() {
  return &nav2_msgs::msg::typesupport_microxrcedds_cpp::_CostmapMetaData__handle;
}
