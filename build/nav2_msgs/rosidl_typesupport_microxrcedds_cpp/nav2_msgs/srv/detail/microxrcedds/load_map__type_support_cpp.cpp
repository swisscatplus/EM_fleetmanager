...
#include "nav2_msgs/srv/detail/load_map__rosidl_typesupport_microxrcedds_cpp.hpp"
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, LoadMap_Request)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap_Request__handle;
}
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, LoadMap_Response)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap_Response__handle;
}
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, LoadMap)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_LoadMap__handle;
}
