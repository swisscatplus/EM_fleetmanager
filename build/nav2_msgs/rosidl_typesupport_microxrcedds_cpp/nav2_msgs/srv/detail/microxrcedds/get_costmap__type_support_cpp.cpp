...
#include "nav2_msgs/srv/detail/get_costmap__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: specs
  current_alignment += nav2_msgs::msg::typesupport_microxrcedds_cpp::get_serialized_size(
    ros_message.specs,
    current_alignment);
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: specs
  current_alignment += nav2_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_CostmapMetaData(
    full_bounded,
    current_alignment);
...
static size_t _GetCostmap_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _GetCostmap_Request__callbacks = {
  ...
  _GetCostmap_Request__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap_Request)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: map
  current_alignment += nav2_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_Costmap(
    full_bounded,
    current_alignment);
...
static size_t _GetCostmap_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const nav2_msgs::srv::GetCostmap_Response *>(
...
static message_type_support_callbacks_t _GetCostmap_Response__callbacks = {
  ...
  _GetCostmap_Response__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap_Response)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap_Response__handle;
}
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_GetCostmap__handle;
}
