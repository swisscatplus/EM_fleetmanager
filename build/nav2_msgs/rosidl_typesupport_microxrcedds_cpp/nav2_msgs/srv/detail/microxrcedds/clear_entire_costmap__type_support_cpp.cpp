...
#include "nav2_msgs/srv/detail/clear_entire_costmap__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _ClearEntireCostmap_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _ClearEntireCostmap_Request__callbacks = {
  ...
  _ClearEntireCostmap_Request__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearEntireCostmap_Request__handle;
}
...
static size_t _ClearEntireCostmap_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const nav2_msgs::srv::ClearEntireCostmap_Response *>(
...
static message_type_support_callbacks_t _ClearEntireCostmap_Response__callbacks = {
  ...
  _ClearEntireCostmap_Response__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearEntireCostmap_Response__handle;
}
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearEntireCostmap__handle;
}
