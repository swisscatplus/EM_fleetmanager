...
#include "nav2_msgs/srv/detail/clear_costmap_except_region__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _ClearCostmapExceptRegion_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _ClearCostmapExceptRegion_Request__callbacks = {
  ...
  _ClearCostmapExceptRegion_Request__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, ClearCostmapExceptRegion_Request)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion_Request__handle;
}
...
static size_t _ClearCostmapExceptRegion_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const nav2_msgs::srv::ClearCostmapExceptRegion_Response *>(
...
static message_type_support_callbacks_t _ClearCostmapExceptRegion_Response__callbacks = {
  ...
  _ClearCostmapExceptRegion_Response__get_serialized_size_with_initial_alignment,
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, ClearCostmapExceptRegion_Response)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion_Response__handle;
}
...
{
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, ClearCostmapExceptRegion)() {
  return &nav2_msgs::srv::typesupport_microxrcedds_cpp::_ClearCostmapExceptRegion__handle;
}
