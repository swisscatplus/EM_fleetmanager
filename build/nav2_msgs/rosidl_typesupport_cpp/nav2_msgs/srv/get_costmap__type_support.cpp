...
static const _GetCostmap_Request_type_support_symbol_names_t _GetCostmap_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap_Request)),
  }
};
...
static const _GetCostmap_Response_type_support_symbol_names_t _GetCostmap_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap_Response)),
  }
};
...
static const _GetCostmap_type_support_symbol_names_t _GetCostmap_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav2_msgs, srv, GetCostmap)),
  }
};
